export interface Product {
  ...
  image: string;
  inStock: boolean;
  salesTag?: string; // e.g. "Like New", "Refurbished", "Good", "Fair"
...
export const PRODUCTS: Product[] = [
  {
    ...
    inStock: true,
    salesTag: "Vintage (Excellent)",
    conditionText: "Excellent vintage condition. Genuine heavy cowhide leather. No tears, zippers work perfectly. Light natural patina.",
  ...
  },
  {
    ...
    inStock: true,
    salesTag: "Refurbished (Like New)",
    conditionText: "Like New condition. 100% functional. Battery health is at 92% (145 charge cycles). Zero visible scratches on screen.",
  ...
  },
  {
    ...
    inStock: true,
    salesTag: "Collectible (Good)",
    conditionText: "Good condition. Console has minor yellowing common with aged ABS plastic. Tested and works perfectly. Comes with all cables and 1 original controller.",
  ...
  },
  {
    ...
    inStock: true,
    salesTag: "Special Deal (Excellent)",
    conditionText: "Excellent working condition. Shutter speeds are accurate, light meter is fully functional, view finder is clear. Light seals replaced recently.",
  ...
  },
  {
    ...
    inStock: true,
    salesTag: "Pre-owned (Good)",
    conditionText: "Good condition. Minimal fret wear. Small ding on the lower bout (cosmetic only, does not affect sound). Setup with low action for easy playability.",
  ...
  },
  {
    ...
    reviewCount: 15,
    category: "Electronics (Refurbished)",
    image: "/refurbished_laptop.png", // Reusing for electronics feel
    inStock: true,
    salesTag: "Refurbished (Excellent)",
    conditionText: "Excellent condition. Back panel has a tiny pinhole dent near the logo. Screen has a tempered glass protector pre-applied. Includes charger.",
  ...
  },
  {
    ...
    reviewCount: 28,
    category: "Vintage Fashion",
    image: "/vintage_jacket.png", // Vintage feel
    inStock: true,
    salesTag: "Pre-owned (Good)",
    conditionText: "Good condition. Nicely broken-in denim with natural fading at knees and pockets. No rips or stains.",
  ...
  },
  {
    ...
    inStock: true,
    salesTag: "Collectible (Good)",
    conditionText: "Good condition. Laser lens cleaned and calibrated. Plays both CD and DVD games perfectly. Includes 1 DualShock 2 controller and memory card.",
  ...
  },
  {
    ...
    image: "/vintage_camera.png", // Handcrafted look
    inStock: true,
    salesTag: "Second-hand (Excellent)",
    conditionText: "Excellent condition. Crafted from solid teak wood. Polish is intact. Felt pads on the bottom to protect your desk surface.",
  ...
  },
  {
    ...
    image: "/refurbished_laptop.png",
    inStock: true,
    salesTag: "Pre-owned (Very Good)",
    conditionText: "Very Good condition. Barely noticeable scratches on the back casing. Screen is 100% scratch-free. Battery life lasts up to 4 weeks.",
  ...
  },
  {
    ...
    inStock: false,
    salesTag: "Sold Out",
    conditionText: "Good condition. Red flag pop-up exposure indicator works. Lens is clean. Selenium solar cell is responsive. SOLD OUT.",
  ...
  },
  {
    ...
    reviewCount: 31,
    category: "Electronics (Refurbished)",
    image: "/refurbished_laptop.png", // placeholder sound/elec
    inStock: true,
    salesTag: "Special Deal (Good)",
    conditionText: "Good condition. Brand new replacement ear pads and headband cushion installed. Minor rubbing marks on outer cups. Excellent battery.",
