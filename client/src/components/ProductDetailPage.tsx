...
import { CartIcon, StarIcon, CheckIcon, ShieldIcon } from './Icons';
...
export const ProductDetailPage: React.FC<ProductDetailPageProps> = ({
  ...
  return (
    <div className="product-page-container">
      {/* Back Button */}
      <button className="product-page-back-btn" onClick={onBack}>
        ← Back to Storefront
      </button>
          ...
          <div className="detail-action-panel">
            {inStock && (
              <div className="qty-selector">
                ...
                <button 
                  disabled={quantity >= 5} // Limit checkouts to 5 max
                  onClick={() => setQuantity(prev => prev + 1)}
      ...
      <div className="detail-tabs-section" style={{ marginTop: '40px', borderRadius: 'var(--radius-md)', overflow: 'hidden', border: '1px solid var(--border-color)' }}>
        <div className="detail-tabs-header" style={{ padding: '0 20px' }}>
          <button 
        ...
        <div className="detail-tabs-body" style={{ padding: '30px' }}>
          {activeTab === 'specs' && (
